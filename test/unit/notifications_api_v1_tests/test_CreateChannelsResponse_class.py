...
class TestCreateChannelsResponse(unittest.TestCase):
    app = {}
    @classmethod
    def setup_class(cls):
    ...
    def test_to_dict_success(self):
        TestCreateChannelsResponse.app.to_dict()

    """__eq__ test cases """

    def test__eq__isinstance(self):
        TestCreateChannelsResponse.app.__eq__(TestCreateChannelsResponse.app)

    def test__eq__not_isinstance(self):
        TestCreateChannelsResponse.app.__eq__({})

    """__ne__ test cases """

    def test__ne__isinstance(self):
        TestCreateChannelsResponse.app.__ne__(TestCreateChannelsResponse.app)
