...
class TestChannelResponseDefinitionAlertSourceItem(unittest.TestCase):
    app = {}
    @classmethod
    def setup_class(cls):
    ...
    def test_to_dict_success(self):
        TestChannelResponseDefinitionAlertSourceItem.app.to_dict()

    """__eq__ test cases """

    def test__eq__isinstance(self):
        TestChannelResponseDefinitionAlertSourceItem.app.__eq__(TestChannelResponseDefinitionAlertSourceItem.app)

    def test__eq__not_isinstance(self):
        TestChannelResponseDefinitionAlertSourceItem.app.__eq__({})

    """__ne__ test cases """

    def test__ne__isinstance(self):
        TestChannelResponseDefinitionAlertSourceItem.app.__ne__(TestChannelResponseDefinitionAlertSourceItem.app)
